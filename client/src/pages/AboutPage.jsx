          ...
          >
            <Stack gap="xl">
              <div style={{ textAlign: 'center' }}>
                ...
                <Text size="xl" c="rgba(255,255,255,0.9)" maw={800} mx="auto" lh={1.6}>
              ...
              <SimpleGrid cols={{ base: 1, md: 3 }} spacing={60} mt={60}>
                {targetDemographics.map((group, index) => (
                  ...
                  >
                    ...
                    >
                      <Stack align="center" gap="md" style={{ height: '100%', justifyContent: 'center' }}>
                        <div style={{ marginBottom: '0.5rem' }}>
                          {group.icon}
                        </div>
                        <Title order={3} size="h3" fw={700} c="var(--color-primary)">
                          {group.title}
                        </Title>
                        <Text 
                          size="sm" 
